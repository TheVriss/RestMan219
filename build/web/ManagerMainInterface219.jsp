...
<html lang="en">
    <head>
        ...
        <title>RestMan | Manager Dashboard</title>
            ...
            <div class="hello-manager">
                <h2>Welcome, 
                    <%= session.getAttribute("manager") != null
                            ? ((User219) session.getAttribute("manager")).getFullName() : "Manager"%>
                </h2>
            </div>
            <div class="dashboard-content">
                <h4 class="mb-4">Manager Dashboard</h4>
                <div class="d-grid gap-2">
                    <a href="getfoods" class="btn btn-success btn-lg">Manage Food</a>
                </div>
            </div>
        </div>
